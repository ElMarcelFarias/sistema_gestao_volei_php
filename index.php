...
<head>
    <meta charset="utf-8" />
    <title>Login | Gestão Vôlei</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 mt-4 text-center">
                                                        ...
                                                        <ul class="list-unstyled social-icon mb-0 mt-3">
                                                            <li class="list-inline-item"><a href="https://www.facebook.com/Focus-Body-100111169200014" target="_blank" class="rounded"><i data-feather="facebook" class="fea icon-sm fea-social"></i></a></li>
                                                            <li class="list-inline-item"><a href="https://github.com/ElMarcelFarias/sistema_gestao_volei_php" target="_blank" class="rounded"><i data-feather="github" class="fea icon-sm fea-social"></i></a></li>
                                                            <li class="list-inline-item"><a href="https://www.instagram.com/farias.marcell/" target="_blank" class="rounded"><i data-feather="instagram" class="fea icon-sm fea-social"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </form>
